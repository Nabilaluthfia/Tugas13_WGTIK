...
if response == '1':
    ...
    a = int(input("masukkan port range terkecil : "))
    b = int(input("masukkan port range terbesar : "))
    port_range = f"{a}-{b}"
...
# If user's input is 4, perform a Regular Scan
    ...
    print(scanner.scan("192.168.1.3", arguments="-O")['scan']['192.168.1.3']['osmatch'][1])
